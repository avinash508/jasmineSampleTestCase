...
describe( "Calculator", function(){
  ...
  it("add a and b should fail", function(){
    expect( calculator.add.bind(abc, 'a', 'b') ).to.throw('calculator error');
  });
...
describe( "ScientificCalculator", function(){
  ...
  it( "extends Calculator", function(){
    ...
    expect( calculator ).to.be.an.instanceOf(ScientificCalculator);
  });
